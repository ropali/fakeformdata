...
export default class Quotes extends Component {
    ...
    state = getRandomQuotes();

    render() {

        const { text, from } = this.state

        return (
            <React.Fragment>
                <span style={{ display:'block', fontStyle:'italic' }} className="card-subtitle mt-3 text-muted">Start With Motivation</span>
